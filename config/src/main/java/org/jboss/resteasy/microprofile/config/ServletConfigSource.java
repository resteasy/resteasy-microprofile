...
public class ServletConfigSource implements ResteasyConfigSource {
    private volatile String name;

    @Override
    public Map<String, String> getProperties() {
        final ServletConfig config = ResteasyContext.getContextData(ServletConfig.class);
        if (config == null) {
        ...
        if (currentName == null) {
            synchronized (this) {
                ...
                if (currentName == null) {
                    ...
                    final ServletConfig servletConfig = ResteasyContext.getContextData(ServletConfig.class);
